...
// -----------------------------------------------------------------
    ...
    public String metodo1( )
    {
        ...
        return +carrosPlacaPB()+ "Hay carro parqueado 24 o mas horas";
    }
    ...
    public double darTiempoPromedio(){
        ...
        for(Puesto pp:puestos){
            Carro carro = pp.darCarro();
            if(carro !=null){
                int tParqueado = carro.darTiempoEnParqueadero(horaActual);
                totalTiempo+=tParqueado;
                tCarros++;
            }
        }
        if(tCarros >0){
            double tiempoPromedio = (double) totalTiempo/tCarros;
    ...
    public void carrosParqueados(){
        for(Puesto pp:puestos){
            Carro carro = pp.darCarro();
            if (carro !=null){
                System.out.println(""+carro.darPlaca());
                System.out.println(""+carro.darHoraLlegada());
            }
        }
    }
    ...
    public boolean hay1CarroMasDeOchoHoras(){
        boolean hCarro=false;
        for (Puesto pp: puestos){
            Carro carro = pp.darCarro();
            if (carro !=null){
                int tParqueado = carro.darTiempoEnParqueadero(horaActual);
    ...
    public ArrayList<Carro> darCarros3Horas(){
    ...
    public boolean hayCarrosPlacaIgual(){
        try{
            for (int i=0; i<puestos.length-1; i++){
                ...
                for (int h = i +1; h<puestos.length; h++) {
                    Carro carro2 = puestos[h].darCarro();
    ...
    public boolean carros24h(){
        boolean hayCarro24 = false;
        for (Puesto pp:puestos){
            Carro carro = pp.darCarro();
            if(carro !=null){
                int tParqueadero = carro.darTiempoEnParqueadero(horaActual);
                if(tParqueadero>=24){
                    hayCarro24=true;
                }else {
                    hayCarro24=false;
    ...
    public void vaciarParqueadero(){
        ...
        System.out.println(""+contadorParqueadero);
    }
